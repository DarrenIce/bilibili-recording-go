...
func Cors() gin.HandlerFunc {
    return func(c *gin.Context) {
        ...
        if origin != "" {
            ...
            c.Header("Access-Control-Allow-Headers", "Authorization, Content-Length, X-CSRF-Token, Token,session, Access-Control-Allow-Methods, Content-Type, Access-Control-Allow-Origin, Access-Control-Allow-Credentials")
